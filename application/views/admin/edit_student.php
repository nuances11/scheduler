			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            ...
                            <form class="form-horizontal form-bordered" action="<?php echo base_url();?>student/update" method="POST">
								<div class="form-group">
									<input type="hidden" name="id" value="<?php echo $student->id; ?>">
									<label class="control-label col-md-4 col-sm-4" for="message">Student Number:</label>
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" value="<?php echo $student->studno; ?>" id="studno" name="studno" data-parsley-type="number" placeholder="Student Number" />
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" value="<?php echo $student->lname; ?>" id="fullname" name="lname" placeholder="Last Name" data-parsley-required="true" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" value="<?php echo $student->fname; ?>" id="fullname" name="fname" placeholder="First Name" data-parsley-required="true" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" value="<?php echo $student->mname; ?>" id="fullname" name="mname" placeholder="Middle Name" data-parsley-required="true" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" value="<?php echo $student->address; ?>" id="fullname" name="address" placeholder="Address" data-parsley-required="true" />
									</div>
								</div>
