<!-- begin breadcrumb -->
			<ol class="breadcrumb pull-right">
				...
				<li class="active">Add New Principal</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Add New Principal<small></small></h1>
			<!-- end page-header -->
<!-- begin row -->
			<div class="row">
                <!-- begin col-6 -->
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        <div class="panel-heading">
                            <h4 class="panel-title">Add New Principal</h4>
                        </div>
                        <div class="panel-body panel-form">
                            ...
                            <form class="form-horizontal form-bordered" action="<?php echo base_url();?>principal/save" method="POST">
